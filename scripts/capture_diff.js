...
const OUTPUT_DIR = path.join(__dirname, '../../../../Users/Administrator/.gemini/antigravity-ide/brain/106bacfb-a52a-40ee-8438-6c910938b386');
...
async function main() {
  ...
  console.log("Scanning slides to find '如何验收效果？'...");
  let found = false;
  for (let i = 0; i < totalSlides; i++) {
    const text = await page.evaluate(() => document.body.innerText);
    if (text.includes('如何验收效果？')) {
        await page.evaluate(() =>
          Promise.all([...document.images].map(img => img.complete ? Promise.resolve() : new Promise(r => { img.onload = r; img.onerror = r; })))
        );
        await new Promise(r => setTimeout(r, 1000));
        
        const outputPath = 'C:/Users/Administrator/.gemini/antigravity-ide/brain/106bacfb-a52a-40ee-8438-6c910938b386/geo_kpi_verify.png';
        ...
        console.log(`✅ Successfully saved target slide to geo_kpi_verify.png`);
        found = true;
        break;
    }
