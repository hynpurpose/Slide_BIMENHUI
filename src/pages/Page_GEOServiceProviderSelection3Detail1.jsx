...
export default function Page_GEOServiceProviderSelection3Detail1() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full flex items-center justify-start relative z-10 select-none">
        ...
        {/* Full-width Image Spot (top-0 bottom-0 left-0 right-0 / w-full h-full - sharp corners, no border) */}
        <div className="w-full h-full bg-zinc-950/40 overflow-hidden flex items-center justify-center z-20">
          {!rightImgFailed ? (
            <img
              src="/images/geo-service-provider-3-detail-1.png"
              alt="内容质量一"
            ...
            <div className="w-full h-full flex flex-col items-center justify-center p-8 gap-4 select-none">
              ...
              <span className="text-zinc-400 font-bold text-2xl font-['MiSans']">内容质量 示意图 一</span>
              <span className="text-zinc-650 text-[16px]">此处展示首个高质量内容对比或具体评判维度截图</span>
            </div>
          )}
        </div>
...
Page_GEOServiceProviderSelection3Detail1.hideHeader = true;
