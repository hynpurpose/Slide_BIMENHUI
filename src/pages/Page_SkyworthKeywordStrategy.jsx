...
function PageSubtitle() {
  return (
    <div className="absolute top-[5px] left-0 w-full text-[22px] text-zinc-400 font-medium font-['MiSans'] leading-relaxed">
      三层关系护城河：融合词条分类体系，从基石到包围圈，再到外围防线。
    </div>
  );
}
    ...
    <SlideLayout title="核心词条分类与护城河策略">
      ...
      >
        ...
        >
          ...
          <defs>
            {/* 蓝天色渐变 - 监测词 */}
            <linearGradient id="cyanGrad" x1="230" y1="20" x2="230" y2="190" gradientUnits="userSpaceOnUse">
          ...
          {/* 顶层 / 护城河 : 监测词 */}
          <path 
            d="M 230 20 L 310 190 L 150 190 Z" 
            fill="url(#cyanGrad)" 
            stroke="#38BDF8" 
            strokeWidth="2" 
            filter="url(#neonGlow)" 
          ...
          {/* 中层 : 产品专属词 */}
          <path 
            d="M 146 200 L 314 200 L 394 380 L 66 380 Z" 
            fill="url(#tealGrad)" 
            stroke="#2DD4BF" 
            strokeWidth="2" 
          />
          ...
          {/* 底层 : 品类词 */}
          <path 
            d="M 76 390 L 384 390 L 460 570 L 0 570 Z" 
            fill="url(#blueGrad)" 
            stroke="#3B82F6" 
            strokeWidth="2.5" 
          />
        ...
        {/* ==================== 放置在金字塔上的文字标签 (支持响应式定位) ==================== */}
        {/* 顶层文字 */}
        <div className="absolute flex flex-col items-center justify-center pointer-events-none" style={{ left: '0px', top: '100px', width: '460px' }}>
          <span className="text-[32px] font-black text-white leading-none tracking-wide">监测词</span>
          <span className="text-[16px] font-bold text-sky-200 mt-1">外围 / 护城河</span>
        </div>

        {/* 中层文字 */}
        <div className="absolute flex flex-col items-center justify-center pointer-events-none" style={{ left: '0px', top: '265px', width: '460px' }}>
        ...
        <div className="absolute select-text" style={{ left: '635px', top: '0px', width: '1205px', height: '580px' }}>
          ...
          {/* 1. 监测词说明 */}
          <div className="absolute flex flex-col justify-center" style={{ top: '45px', height: '130px' }}>
            <div className="flex items-baseline gap-3">
              <h3 className="text-[28px] font-black text-white">监测词</h3>
              <span className="text-[16px] text-zinc-500 font-bold border border-zinc-800 px-2 py-0.5 rounded bg-zinc-900/50">
                监测范围：品类词、产品专属词
              </span>
            </div>
            <p className="text-[20px] text-zinc-300 leading-relaxed mt-2 font-normal">
              核心目的：起到“润滑”和保护作用。虽然不直接产生主要优化效果，但它是护城河。如果外围负面信息过高，内部的优化就会被淹没或受到严重影响。
            </p>
          </div>

          {/* 2. 产品专属词说明 */}
          <div className="absolute flex flex-col justify-center" style={{ top: '225px', height: '130px' }}>
            <div className="flex items-baseline gap-3">
          ...
          {/* 3. 品类词说明 */}
          <div className="absolute flex flex-col justify-center" style={{ top: '415px', height: '130px' }}>
            <div className="flex items-baseline gap-3">
