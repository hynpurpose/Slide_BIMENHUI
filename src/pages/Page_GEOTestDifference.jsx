    ...
    >
      ...
      <div className="w-full h-full flex items-stretch relative z-10 select-none">
        ...
        <div className="w-[860px] flex items-stretch justify-start relative">
          ...
          {/* Smartphone mockup */}
          <div className="absolute top-[-145px] bottom-0 w-[400px] left-[80px] border-[8px] border-zinc-800 bg-zinc-950 rounded-[48px] shadow-[0_25px_60px_rgba(0,0,0,0.85)] overflow-hidden">
