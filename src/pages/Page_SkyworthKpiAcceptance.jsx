  ...
  return (
    <SlideLayout fullBleed>
      <div className="w-full h-full flex flex-col relative text-white font-sans overflow-hidden bg-black animate-fade-in">
        ...
        {/* ── 核心排版区 (从 top 225px 抵到 bottom 16px，宽度 1840px，居中对齐) ── */}
        <div className="absolute top-[225px] left-[40px] w-[1840px] bottom-[16px] flex flex-col justify-between z-10 gap-4">
          
          {/* ── 上部：品牌当前现状 (包含 3 个并列卡片，无小字解释) ── */}
          <div className="shrink-0">
            ...
            <div className="grid grid-cols-12 gap-4">
              {/* 品类词现状 */}
              <div className="col-span-5 bg-white/[0.02] border border-white/[0.06] rounded-xl px-5 py-2.5 flex flex-col justify-center">
              ...
              {/* 负面及错误现状 */}
              <div className="col-span-2 bg-white/[0.02] border border-white/[0.06] rounded-xl px-4 py-2.5 flex flex-col justify-center">
                <span className="text-[17px] xl:text-[19px] font-bold text-zinc-300 mb-1.5 whitespace-nowrap">
                  负面及错误信息现状
                </span>
                <div className="flex flex-col">
                  <span className="text-zinc-500 text-[14px] xl:text-[15px] font-medium whitespace-nowrap">负面及异常回答比例</span>
          ...
          {/* ── 下部：KPI与交付标准表格 (还原原版4列且文字绝不作任何更改，填满可用空间) ── */}
          <div className="flex flex-col justify-start min-h-0 flex-1">
            ...
            <div className="w-full flex-grow flex flex-col justify-center min-h-0 bg-white/[0.02] border border-white/[0.08] rounded-2xl py-[10px] px-[20px] xl:py-[14px] xl:px-[26px] shadow-2xl">
              <table className="w-full text-left border-collapse h-full">
                ...
                <tbody className="text-[19px] xl:text-[21px] leading-snug">
                  ...
                  <tr className="hover:bg-white/[0.01] transition-colors duration-200 border-b border-white/[0.22]">
                    ...
                    <td className="py-3 text-zinc-300 align-top pr-4 border-l border-white/[0.22] pl-6">
                      <div className="flex flex-col gap-2 bg-[#004CE5]/5 border border-[#004CE5]/15 p-2.5 xl:p-3 rounded-xl">
                        <p className="text-zinc-150 text-[18px] xl:text-[20px] leading-snug text-justify">
                  ...
                  <tr className="hover:bg-white/[0.01] transition-colors duration-200">
                    ...
                    <td className="py-3 text-zinc-400 align-top pr-4 leading-snug border-l border-white/[0.22] pl-6 text-zinc-200">
                      <div className="flex flex-col gap-2 bg-white/[0.015] border border-white/[0.04] p-2.5 xl:p-3 rounded-xl text-[18px] xl:text-[20px] text-justify">
                        <p>
                          围绕约定平台、5 款壁纸电视及核心词条，持续监测并纠偏价格错乱、型号混淆、历史价格引用等问题，通过信源定位、官方口径强化和内容覆盖，降低 AI 引用错误信息的概率。
                        </p>
                        <p className="border-t border-white/10 pt-2 text-zinc-400 text-[15px] xl:text-[17px]">
