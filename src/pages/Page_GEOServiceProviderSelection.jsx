...
export default function Page_GEOServiceProviderSelection() {
  ...
  const iconPath = "/icons/provider-icon-1.svg";
  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full flex items-center justify-start relative z-10 select-none">
        ...
        {/* Card 01 (Using Card 02 Blue Highlight Styling) */}
        ...
        {/* Right Column: Image Spot (top-[-145px] bottom-0 right-0 w-[1300px]) */}
        <div className="absolute w-[1300px] right-0 top-[-145px] bottom-0 border border-[#004CE5]/30 bg-zinc-950/40 rounded-[32px] shadow-[0_25px_60px_rgba(0,0,0,0.85)] overflow-hidden flex items-center justify-center z-20">
          {!rightImgFailed ? (
            <img
              src="/images/geo-service-provider-1.png"
              alt="品牌调研 & 数据库建设方案"
            ...
            <div className="w-full h-full flex flex-col items-center justify-center p-8 gap-4 select-none">
              ...
              <span className="text-zinc-400 font-bold text-2xl font-['MiSans']">品牌调研 & 建立品牌数据库 示意图</span>
              <span className="text-zinc-600 text-[16px]">此处展示品牌调研及数据库相关成果截图</span>
            </div>
          )}
        </div>
