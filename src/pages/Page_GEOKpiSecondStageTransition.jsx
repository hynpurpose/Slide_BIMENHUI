...
export default function Page_GEOKpiSecondStageTransition() {
  return (
    <SlideLayout>
      <div className="w-full h-full flex flex-col justify-center relative z-10">
        ...
        <div className="flex items-center justify-center w-full relative" style={{ top: '-80px' }}>
          <div className="w-full px-12">
            ...
            >
              第二关：<br />
              <span className="text-[#004CE5] font-extrabold">KPI 怎么定？</span>
            </h2>
          </div>
        </div>
...
Page_GEOKpiSecondStageTransition.hideHeader = true;
