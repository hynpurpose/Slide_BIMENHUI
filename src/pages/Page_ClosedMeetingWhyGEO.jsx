...
export default function Page_ClosedMeetingWhyGEO() {
  return (
    <SlideLayout>
      <div className="w-full h-full flex flex-col justify-center relative z-10">
        ...
        <div className="flex items-center justify-center w-full relative" style={{ top: '-80px' }}>
          <div className="w-full">
            ...
            >
              我们团队为什么在2024年<br />
              决定<span className="text-[#004CE5] font-extrabold ml-2">全力押注 GEO？</span>
            </h2>
          </div>
        </div>
...
Page_ClosedMeetingWhyGEO.hideHeader = true;
