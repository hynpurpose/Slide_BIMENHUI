...
export default function Page_GEOWordSelectionSemTransition() {
  return (
    <SlideLayout>
      <div className="w-full h-full flex flex-col justify-center relative z-10">
        ...
        <div className="flex items-center justify-center w-full relative" style={{ top: '-80px' }}>
          <div className="w-full">
            ...
            >
              更重要的是，<br />
              <span className="text-[#004CE5] font-extrabold">AI 搜索和过去的百度 SEM 不一样。</span>
            </h2>
          </div>
        </div>
...
Page_GEOWordSelectionSemTransition.hideHeader = true;
