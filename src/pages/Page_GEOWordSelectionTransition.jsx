...
export default function Page_GEOWordSelectionTransition() {
  return (
    <SlideLayout>
      <div className="w-full h-full flex flex-col justify-center relative z-10">
        ...
        <div className="flex items-center justify-center w-full relative" style={{ top: '-80px' }}>
          <div className="w-full">
            ...
            >
              所以，传统搜索里，选词更多是在选流量；<br />
              <span className="text-[#004CE5] font-extrabold">但在 AI 里，选词其实是在重新做一遍品牌定位。</span>
            </h2>
          </div>
        </div>
...
Page_GEOWordSelectionTransition.hideHeader = true;
