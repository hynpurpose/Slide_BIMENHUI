...
export default function Page_GEOServiceProviderSelectionTransition3() {
  return (
    <SlideLayout>
      <div className="w-full h-full flex flex-col justify-center relative z-10">
        ...
        <div className="flex items-center justify-center w-full relative" style={{ top: '-80px' }}>
          <div className="w-full px-12">
            ...
            >
              除了数量，<br />
              <span className="text-[#004CE5] font-extrabold">更要看内容质量</span>
            </h2>
          </div>
        </div>
...
Page_GEOServiceProviderSelectionTransition3.hideHeader = true;
