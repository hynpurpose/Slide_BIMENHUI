...
export default function Page_ClosedMeetingConversionIntro() {
  return (
    <SlideLayout>
      <div className="w-full h-full flex flex-col justify-center relative z-10">
        ...
        <div className="flex items-center justify-center w-full relative" style={{ top: '-80px' }}>
          <div className="w-full">
            ...
            >
              GEO到底能不能<br />
              帮品牌带来<span className="text-[#004CE5] font-extrabold ml-2">销售转化？</span>
            </h2>
          </div>
        </div>
...
Page_ClosedMeetingConversionIntro.hideHeader = true;
