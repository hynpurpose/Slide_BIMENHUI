...
export default function Page_GEOWordSelectionDataChain() {
  return (
    <SlideLayout title="AI 提问量数据从哪来？一条买来的数据链">
      <div className="absolute select-none" style={{ top: '30px', left: 0, width: '1840px', height: '560px' }}>
      ...
      <div
        ...
        style={{ left: 0, right: 0, top: '640px', borderLeft: '6px solid #004CE5', padding: '6px 0 6px 28px', fontSize: '25px', lineHeight: '38px', color: '#D4D4D8' }}
      >
...
Page_GEOWordSelectionDataChain.hideHeader = true;
