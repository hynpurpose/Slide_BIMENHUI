...
export default function Page_SearchEntryTrend() {
  ...
  return (
    <div className="w-full h-full flex flex-col relative bg-zinc-950 text-white font-sans select-none overflow-hidden justify-between pt-8 pb-6 px-12">
      ...
      <div className="grid grid-cols-2 gap-8 w-full flex-grow items-stretch relative z-10 min-h-0 mb-2">

        {/* Left Column */}
        <div className="flex flex-col h-full transition-all duration-300">

          {/* Image Slot 1 */}
          <div className="w-full h-[440px] xl:h-[520px] flex items-center justify-center p-6 bg-zinc-900/10 border border-zinc-900/30 rounded-2xl shadow-subtle-glow backdrop-blur-sm">
            {!leftImgFailed ? (
              <img
                src={leftImagePath}
        ...
        <div className="flex flex-col h-full transition-all duration-300">
          ...
          <div className="w-full h-[440px] xl:h-[520px] flex items-center justify-center p-6 bg-zinc-900/10 border border-zinc-900/30 rounded-2xl shadow-subtle-glow backdrop-blur-sm">
            {!rightImgFailed ? (
              ...
              <svg viewBox="0 0 400 240" className="h-full w-auto max-w-full overflow-visible">
                ...
                <rect x="95" y="127" width="40" height="53" rx="4" fill="#4b5563" />
                <text x="115" y="115" fill="#9ca3af" fontSize="13" fontWeight="bold" textAnchor="middle">38%</text>
                ...
                <rect x="265" y="74" width="40" height="106" rx="4" fill="#3b82f6" />
                <text x="285" y="60" fill="#3b82f6" fontSize="15" fontWeight="bold" textAnchor="middle">76%</text>
          ...
          <div className="mt-4 flex flex-col justify-center flex-grow py-1">
            <h3 className="text-2xl xl:text-3xl font-bold text-zinc-300 leading-relaxed border-l-[3px] border-blue-500 pl-4">
              消费者<span className="text-blue-400 font-extrabold">更信任AI</span>给出的答案，进不了AI的推荐的品牌，很难进入用户的购买选择。
            </h3>
          </div>
        </div>
