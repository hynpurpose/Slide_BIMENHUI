...
export default function Page_GEOServiceProviderSelectionTransition2() {
  return (
    <SlideLayout>
      <div className="w-full h-full flex flex-col justify-center relative z-10">
        ...
        <div className="flex items-center justify-center w-full relative" style={{ top: '-80px' }}>
          <div className="w-full px-12">
            ...
            >
              做 GEO，<br />
              <span className="text-[#004CE5] font-extrabold">必须要有数据监测系统</span>
            </h2>
          </div>
        </div>
...
Page_GEOServiceProviderSelectionTransition2.hideHeader = true;
