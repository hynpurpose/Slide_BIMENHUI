...
export default function Page_GEOServiceProviderSelection4Detail1() {
    ...
    >
      ...
      <div className="w-full h-full flex items-center justify-start relative z-10 select-none">
        ...
        <div className="absolute w-[1378px] right-0 top-0 bottom-0 border border-[#004CE5]/60 bg-zinc-950/40 overflow-hidden flex items-center justify-center z-20 p-6">
          {!rightImgFailed ? (
            <img
              src="/images/geo-service-provider-721.png"
              alt="721原则"
              className="w-full h-full object-contain"
            ...
            <div className="w-full h-full flex flex-col items-center justify-center p-8 gap-4 select-none">
              ...
              <span className="text-zinc-400 font-bold text-2xl font-['MiSans']">721原则 示意图</span>
              <span className="text-zinc-650 text-[16px]">此处展示721原则或投放比例划分图截图</span>
            </div>
          )}
        </div>
...
Page_GEOServiceProviderSelection4Detail1.hideHeader = true;
