...
export default function Page_GEOPlatformSelectionTransition() {
  return (
    <SlideLayout>
      <div className="w-full h-full flex flex-col justify-center relative z-10">
        ...
        <div className="flex items-center justify-center w-full relative" style={{ top: '-80px' }}>
          <div className="w-full px-12">
            <h2
              className="text-[128px] font-black tracking-wide text-white text-center font-['MiSans']"
              style={{ lineHeight: '1.4', fontSize: '128px' }}
            >
              第一关：<br />
              <span className="text-[#004CE5] font-extrabold">选平台，选词条</span>
            </h2>
          </div>
        </div>
...
Page_GEOPlatformSelectionTransition.hideHeader = true;
