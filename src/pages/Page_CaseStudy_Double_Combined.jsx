...
export default function Page_CaseStudy_Double_Combined() {
  const leftCase = {
    industry: "大家电行业",
    brand: "方太",
    brandId: "fotile", // Brand ID for logo path: /cases/brand-logos/logo-fotile.png
    product: "方太智能油烟机",
    platforms: ['/ai-logos/ai-1.png', '/ai-logos/ai-2.png', '/ai-logos/ai-3.png'],
    summary: "在品牌此前未系统布局「高端智能油烟机」AI 场景的情况下，项目帮助方太完成了在生成式 AI 中对厨房排烟、智能控烟核心问题的整体占领，并为后续在 AI 渠道中的持续流量获取打下了稳定基础。",
    metrics: [
      {
        title: "提及率",
        content: <>由 76.3% <span className="text-[#004CE5] font-bold mx-1">提升至 92.6%</span></>
      },
      {
        title: "平均提及位次",
        content: <>平均位次<span className="text-[#004CE5] font-bold mx-1">提升至 NO.2.6</span></>
      },
      {
        title: "负面信息率",
        content: <>负面率<span className="text-[#004CE5] font-bold mx-1">降至 0.9%</span></>
      }
    ]
  };
  ...
  const rightCase = {
    industry: "3C数码",
    brand: "OPPO手机",
    brandId: "oppo", // Brand ID for logo path: /cases/brand-logos/logo-oppo.png
    product: "OPPO 旗舰系列",
    platforms: ['/ai-logos/ai-1.png', '/ai-logos/ai-2.png', '/ai-logos/ai-4.png', '/ai-logos/ai-5.png'],
    summary: "针对新品在 AI 检索端缺乏声量的问题，项目协助品牌快速切入主流大模型核心答复场景。OPPO 主推旗舰机型在核心词下的提及率及推荐位次明显提升，横评对比表现卓越。",
    metrics: [
      {
        title: "提及率",
        content: <>由 29.6% <span className="text-[#004CE5] font-bold mx-1">提升至 39.7%</span></>
      },
      {
        title: "平均提及位次",
        content: <>平均位次<span className="text-[#004CE5] font-bold mx-1">提升至 NO.3.3</span></>
      },
      {
        title: "负面信息率",
        content: <>负面率<span className="text-[#004CE5] font-bold mx-1">降至 3.1%</span></>
      }
    ]
  };
  ...
  const renderColumn = (data) => (
    <div className="flex-1 bg-[#101010] border border-white/10 rounded-[1.5rem] flex flex-col overflow-hidden relative shadow-[-10px_0_30px_rgba(0,0,0,0.2)] p-8 sm:p-10 group hover:border-white/20 transition-all duration-500">
      ...
      <div className="flex justify-between items-start mb-6 border-b border-white/5 pb-6 shrink-0">
        {/* Left: Brand Name & Capsule (Capsule is enlarged to 20px) */}
        ...
        {/* Middle: Optimization Platforms (Shifted to the left next to brand info, with a divider) */}
        ...
        {/* Right: Brand Logo Slot (No redundant label, even larger size) */}
