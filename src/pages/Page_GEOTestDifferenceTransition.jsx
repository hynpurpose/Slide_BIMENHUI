...
export default function Page_GEOTestDifferenceTransition() {
  return (
    <SlideLayout>
      <div className="w-full h-full flex flex-col justify-center relative z-10">
        ...
        <div className="flex items-center justify-center w-full relative" style={{ top: '-80px' }}>
          <div className="w-full">
            ...
            >
              为什么服务商测试结果<br />
              跟我测试的结果<span className="text-[#004CE5] font-extrabold ml-2">差异很大？</span>
            </h2>
          </div>
        </div>
...
Page_GEOTestDifferenceTransition.hideHeader = true;
