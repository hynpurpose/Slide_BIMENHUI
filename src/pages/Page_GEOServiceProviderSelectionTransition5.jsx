...
export default function Page_GEOServiceProviderSelectionTransition5() {
  return (
    <SlideLayout>
      <div className="w-full h-full flex flex-col justify-center relative z-10">
        ...
        <div className="flex items-center justify-center w-full relative" style={{ top: '-80px' }}>
          <div className="w-full px-12">
            ...
            >
              先用这几个标准筛一遍，<br />
              <span className="text-[#004CE5] font-extrabold">基本就能排除掉大部分不靠谱的服务商</span>
            </h2>
          </div>
        </div>
...
Page_GEOServiceProviderSelectionTransition5.hideHeader = true;
